    ...
    <div className="min-h-screen flex items-center justify-center bg-surface px-4 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8 card-bounce">
          ...
          <p className="text-[10px] font-extrabold uppercase tracking-widest text-slate-400 dark:text-slate-500 mt-1 flex items-center gap-1.5">
        ...
        <p className="text-[10px] text-center text-slate-400 dark:text-slate-500 mt-6 leading-relaxed flex items-center justify-center gap-1">
